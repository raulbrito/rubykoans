...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Inject will keep a counter for the block that is available while looping through all the 'item' 
    # elements. When passing a parameter, it will use it as initializer for the 'sum', instead of 0
  end
